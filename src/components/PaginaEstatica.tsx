...
/**
 * Moldura da página: cabeçalho, texto de abertura e rodapé.
 *
 * Vive em um componente próprio porque é compartilhada entre o site servido
 * pelo Next e a versão de página única publicada como demonstração.
 */
export default function PaginaEstatica({ children }: { children: React.ReactNode }) {
  return (
    <>
